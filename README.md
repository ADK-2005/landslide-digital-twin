...
* **WebGL 3D Hillslope Twin:** Interactive Three.js 3D hillslope with real-time slope angle geometry morphing, dynamic vertex color-mapping based on local $FoS$, displacement vector toggles, and phreatic plane visualization.
